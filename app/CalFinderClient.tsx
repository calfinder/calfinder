  ...
  return (
    <>
      <style jsx global>{`
        ...
        .hero-title{font-family:var(--font-display);font-size:clamp(2.4rem,5.2vw,3.4rem);font-weight:600;line-height:1.02;color:var(--text);letter-spacing:-.035em;margin-bottom:.35rem}.subheadline{font-family:var(--font-body);font-size:1rem;font-weight:450;font-style:normal;color:var(--muted);letter-spacing:0;margin-bottom:1rem}.description{font-size:.95rem;line-height:1.7;color:var(--muted);max-width:500px;margin-bottom:2rem}
        .divider{height:1px;background:var(--border);margin:1.5rem 0 2.25rem}.form-section{margin-bottom:2.5rem}.section-label{display:flex;align-items:center;gap:.75rem;margin-bottom:1rem}.step-number{font-family:var(--font-mono);font-size:.7rem;font-weight:500;color:var(--on-accent);background:var(--accent);border:none;border-radius:7px;padding:0 .1rem;letter-spacing:.01em;line-height:1;display:inline-flex;align-items:center;justify-content:center;height:1.55rem;min-width:1.85rem;box-shadow:0 1px 2px rgba(0,0,0,.18)}.section-title{font-family:var(--font-display);font-size:1.95rem;font-weight:400;letter-spacing:-.01em;text-transform:none;color:var(--text)}
        ...
        .time-range-readout-line{margin:.15rem 0 0;font-family:var(--font-mono);font-size:.8rem;letter-spacing:.02em;color:var(--muted);padding:0;white-space:nowrap;width:fit-content;align-self:flex-start}
        .time-range-time{color:var(--text)}
        .time-range-sep{opacity:0.4;padding:0 .4rem}
        ...
        @media(max-width:640px){
          ...
          .time-range-readout-line{font-size:.76rem;align-self:flex-start;width:fit-content;margin:.15rem 0 0}
